...
public class ChatRoomItemAdapter extends BaseAdapter {
    private ArrayList<ChatRoomItem> chatRoomItemList = new ArrayList<ChatRoomItem>() ;

    public ChatRoomItemAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // 아이템 내 각 위젯에 데이터 반영
        iconImageView.setImageDrawable(chatRoomItem.getIcon());
        titleTextView.setText(chatRoomItem.getTitle());
        descTextView.setText(chatRoomItem.getDesc());
